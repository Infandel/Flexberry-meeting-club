...
namespace IIS.Club
{
    ...
    [View("ClubMeetingL", new string[] {
            "MeetingDate as \'Дата встречи\'"})]
    [AssociatedDetailViewAttribute("ClubMeetingL", "Report", "ReportE", true, "", "Доклады", true, new string[] {
            ""})]
    public class ClubMeeting : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Club.DetailArrayOfReport fReport;
        ...
        public virtual IIS.Club.DetailArrayOfReport Report
        {
            get
            {
                ...
                {
                    this.fReport = new IIS.Club.DetailArrayOfReport(this);
                }
                IIS.Club.DetailArrayOfReport result = this.fReport;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ClubMeetingE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ClubMeetingE", typeof(IIS.Club.ClubMeeting));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ClubMeetingL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ClubMeetingL", typeof(IIS.Club.ClubMeeting));
                }
            }
        }
    }
